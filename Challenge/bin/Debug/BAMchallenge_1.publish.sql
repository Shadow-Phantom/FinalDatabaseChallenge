...
GO
PRINT N'Starting rebuilding table [dbo].[Record]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Record] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Record])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Record] ([CdID], [CdName], [Artist])
        SELECT   [CdID],
                 [CdName],
                 [Artist]
        FROM     [dbo].[Record]
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Record]', N'Record';
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        SELECT   [ClientNum],
                 ...
                 [PricePaid]
        FROM     [dbo].[Sale]
        ORDER BY [ClientNum] ASC, [CdID] ASC;
    END
